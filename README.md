# Portfolio personnel - Rassim Boucenna
...
L'objectif de ce site est de presenter de maniere centralisee mon parcours, mes competences (Dev & Infra/Securite) ainsi que mes principaux projets techniques. 

## Stack technique

Pour le moment, le site est construit de maniere volontairement legere et sans framework lourd :
- HTML5
- CSS3 (Vanilla)
- Deploiement continu automatique via GitHub Pages
